...
const (
	UserService_Echo_FullMethodName = "/user_service.v1.UserService/Echo"
)
...
func (UnimplementedUserServiceServer) Echo(context.Context, *EchoRequest) (*EchoResponse, error) {
