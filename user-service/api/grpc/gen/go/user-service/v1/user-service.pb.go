...
const file_user_service_v1_user_service_proto_rawDesc = "" +
	"\n" +
	"\"user-service/v1/user-service.proto\x12\x0fuser_service.v1\x1a\x1cgoogle/api/annotations.proto\"'\n" +
	"\vEchoRequest\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"(\n" +
	"\fEchoResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2R\n" +
	"\vUserService\x12C\n" +
	"\x04Echo\x12\x1c.user_service.v1.EchoRequest\x1a\x1d.user_service.v1.EchoResponseB\xc5\x01\n" +
...
var file_user_service_v1_user_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_user_service_v1_user_service_proto_goTypes = []any{
	(*EchoRequest)(nil),  // 0: user_service.v1.EchoRequest
	(*EchoResponse)(nil), // 1: user_service.v1.EchoResponse
}
var file_user_service_v1_user_service_proto_depIdxs = []int32{
	0, // 0: user_service.v1.UserService.Echo:input_type -> user_service.v1.EchoRequest
	1, // 1: user_service.v1.UserService.Echo:output_type -> user_service.v1.EchoResponse
