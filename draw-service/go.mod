module github.com/MaxFando/lms/draw-service

go 1.23.8

replace github.com/MaxFando/lms/draw-service/api/grpc => ./api/grpc

require (
	github.com/MaxFando/lms/draw-service/api/grpc v0.0.0-7df3b9617c3230d033eb6b1b30b40e4a44b8d2d5
