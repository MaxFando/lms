...
func (s *Server) CreateDraws(ctx context.Context, req *drawresultservicev1.CreateDrawRequest) (*drawresultservicev1.DrawResponse, error) {
...
func (s *Server) GetDrawsList(ctx context.Context, req *drawresultservicev1.GetDrawsRequest) (*drawresultservicev1.GetDrawsResponse, error) {
	...
	return &drawresultservicev1.GetDrawsResponse{Draws: respDraws}, nil
}
