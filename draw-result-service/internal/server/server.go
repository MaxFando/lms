...
import (
	...
	"github.com/MaxFando/lms/draw-result-service/internal/server/interceptor"
	v1 "github.com/MaxFando/lms/draw-result-service/internal/server/service/v1"
...
func NewServer(logger logger.Logger, serviceServer *v1.DrawResultServer) *Server {
	srv := new(Server)
...
func initGRPCServer(logger logger.Logger, serviceServer *v1.DrawResultServer) *grpc.Server {
	...
	drawresultservicev1.RegisterDrawResultServiceServer(server, serviceServer)
